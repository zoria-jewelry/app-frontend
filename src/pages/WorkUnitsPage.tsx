                    ...
                    >
                        {report && (
                            ...
                            >
                                ...
                                >
                                    {toTableDate(report.periodStart)} –{' '}
                                    {toTableDate(report.periodEnd)}
                                </Typography>
                            </Box>
                        )}
                        ...
                        onSave={(data: CreateWorkUnitFormData) => {
                            ...
                            WorkUnitsApiClient.issueMetal(data)
                                ...
                                .catch((err) => {
                                    if (err.status === 400) {
                                        showToast(
                                            'На складі недостатньо металу для видачі',
                                            'error',
                                        );
                                    } else {
                        ...
                        <ReturnWorkUnitComponent
                            ...
                            onSave={(data: ReturnWorkUnitFormData) => {
                                WorkUnitsApiClient.returnMetal(data)
                                    .then(async () => {
                                        showToast(
                                            'Повернення матеріалу ювеліром було успішно зафіксоване',
                                        );
                                        await fetchReport();
                                    })
                                    .catch((err) => {
                    ...
                    >
                        <Table stickyHeader>
                            <TableHead>
                                <TableRow>
                                    <TableCell
                                        sx={{ backgroundColor: '#b7cfd2', borderTopLeftRadius: 10 }}
                                    >
                                        Матеріал
                                    </TableCell>
                                ...
                                {entriesToDisplay.map((entry) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                {entry.returnedDate
                                                    ? toTableDate(entry.returnedDate)
                                                    : '–'}
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            >
                                                <IconButton
                                                    ...
                                                    aria-controls={
                                                        actionsMenuOpen
                                                            ? 'work-unit-actions-menu'
                                                            : undefined
                                                    }
                                                    aria-expanded={
                                                        actionsMenuOpen &&
                                                        actionsMenuEntry?.id === entry.id
                                                            ? true
                                                            : false
                                                    }
                        ...
                        <SaveMaterialComponent
                            ...
                            onSave={(data: SaveMaterialFormData) => {
                                WorkUnitsApiClient.saveMetal(data)
                                    .then(() => {
                                        showToast(
                                            'Повернення угорілого матеріалу успішно зафіксовано',
                                        );
                                        fetchReport();
                                    })
                                    .catch((err) => {
